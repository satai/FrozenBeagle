...
\def\Podekovani{%
Děkuji rodičům a Julii za trpělivost a profesoru Flegrovi za vedení práce i způsob, jakým se mne ujal.
Také bych rád vyjádřil své díky pražírnám Doubleshot a Bonanza, bez jejich laskavého pražení by tato práce nevznikla.
}
...
\def\KlicovaSlova{%
{evoluce}, {zamrzlá plasticita}, {simulace}, {punkcionalismus}
}
\def\KlicovaSlovaEN{%
{evolution}, {frozen plasticity}, {simulation}, {punctuated equilibrium}
}
...
\include{a1_Parameters}
\include{a2_Constants}
\include{a3_Surova_data}
\include{a4_Reprodukovatelnost}
