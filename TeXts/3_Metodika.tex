...
K otestování dalších hypotéz byly použity lineární modely s poměrem pleiotropních alel a poměrem alel, u kterých se
...
Jako hladina $\alpha$ byla pro všechny hodnoty zvolena hodnota $ p = 0.05 $.