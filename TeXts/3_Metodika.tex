...
První hypotéza byla  otestována po jednotlivých obdobích prostřednictvím logistické regrese, kde nezávislými
proměnnými byly pro každý pokus to, zda populace vyhynula, a s podílem vznikajících pleiotropických a negativně
dominantních alel a jejich interakcí jako nezávislými proměnnými.
