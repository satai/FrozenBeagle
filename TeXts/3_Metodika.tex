...
\begin{enumerate}
    ...
    \item{Populace, kde je nenulové zastoupení alel ovlivňujících alel více složek fenotypu nebo negativně
          dominantních alel se blízko k optimu (na hodnotu fitness $0.95$) dostávají pomaleji.}
