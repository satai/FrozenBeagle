...
dvě pohlaví. Jejich populace je panmická -- žijí v nestrukturovaném prostředí, kde jejich rozložení v prostoru nemá
...
Pokud není jedinec odstraněn turbidostem tak po 64 krocích umírá stářím.
...
nová alela ovlivňuje více složek fenotypu (je \uv{pleiotropická}) a jaká je pravděpodobnost, že se u alely projeví
dominance.
...
v jednom lokus vyskytnou v jedné nebo ve dvou kopiích (dále jsou tyto alely nazývány pro jednoduchost
...
Ostatní alely mají účinek v stejný, ať již jsou na daném locusu na jednom nebo na obou chromosomech.

\begin{tcolorbox}[ title={Pseudokód popisující generování náhodně alely}
                 , breakable
                 ]
...
z chromozomů, je zvolen jeden náhodý locus. Locusy před ním a on jsou naplněny alelami jednoho z rodičů,
lokusy po něm alelami druhého z rodičů, čímž vznikne první chromozom potomka. Druhý chromosom potomka je vytvořen
...
Nad každým lokusem v obou chromosomech je náhodě s pravděpodobností $0.0002$ rozhodnuto, zda u~něj dojde ke změně.
...
Příspěvek alely se může lišit, pokud se nachází ve dvou kopiích v témže lokusu na obou chromozomech --
...
a kompletní historie ve VCS git. Jsou poskytnuty pod oteřenou trojsložkovou BSD licencí.
...
Reprodukovaltenost počítačových simulací by zdánlivě mělo být triviální téma.
