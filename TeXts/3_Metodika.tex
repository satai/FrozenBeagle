...
K otestování dalších dvou hypotéz bude použity lineární modely s poměrem pleiotropních alel a poměrem alel, u kterých se
projevuje negativní dominance, jako nezávislými proměnými. Modely budou spočítány v prostředí statistického jazyka R
\citep{rlanguage}.